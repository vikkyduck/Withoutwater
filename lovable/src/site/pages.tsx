      ...
      <section className="stage border-b border-[color:var(--color-line)]">
        ...
        <PageHead
          ...
          chips={[
            ...
            ["60 минут", "представляем первые релевантные профили под вашу задачу"],
          ]}
        />
...
export const ROUTES: RouteDef[] = [
  {
    ...
    description:
      "Дополнительные мощности для T&D команд без расширения штата: берем на себя реализацию T&D-проектов — поиск внешних экспертов, перевод ваших рабочих практик в обучающие материалы, управление проектами и сборку готовых продуктов обучения.",
    Component: HomePage,
  },
  {
    path: BE.general,
  ...
  },
  {
    ...
    description:
      "Практика, которой внутри нет — без долгого поиска и консалтинга: профили экспертов за 60 минут бесплатно, опыт остается у вас по окончании проекта.",
  ...
  {
    path: "/constructor",
    title: "Команда по подписке: конструктор — БЕЗ ВОДЫ",
    description:
      "Выберите задачи и нажмите на кнопку «Отправить», когда соберете пакет услуг, мы напишем вам в течение рабочего дня.",
