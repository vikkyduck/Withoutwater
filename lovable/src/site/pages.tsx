...
export const ROUTES: RouteDef[] = [
  ...
  },
  {
    ...
    description:
      "Практика, которой внутри нет — без долгого поиска и консалтинга: описание опыта и подтвержденные кейсы практиков за 60 минут бесплатно, опыт остается у вас по окончании проекта.",
