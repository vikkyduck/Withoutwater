...
const SUBSCRIPTION: Unit[] = [
  ...
  },
  {
    ...
    title: "Бизнес-тренер",
    price: 160000,
    what: "Безлимитное привлечение тренера в рамках месяца. Задачи формулируем в начале каждого месяца",
  },
  {
    id: "methodologist",
    title: "Методолог",
    price: 100000,
    what: "Безлимитное привлечение методолога в рамках месяца. Задачи формулируем в начале каждого месяца",
  },
  {
    id: "coordinator",
    title: "Координатор проектов",
    price: 100000,
    what: "Безлимитное привлечение координатора проектов в рамках месяца. Задачи формулируем в начале каждого месяца",
  },
  {
    id: "ai-automation",
