...
const SUBSCRIPTION: Unit[] = [
  ...
  {
    id: "trainer",
    title: "Абонемент на сопровождение по обучению (бизнес-тренер)",
    price: 160000,
  ...
  },
  {
    ...
    price: 100000,
    what: "Разработка учебных программ, аудит существующих курсов и создание методических материалов под запросы бизнеса в течение месяца",
  },
  {
    id: "coordinator",
    title: "Абонемент на проектное управление (координатор)",
    price: 100000,
    what: "Организация процессов, контроль дедлайнов, ведение проектной документации и координация рабочих встреч силами нашей компании",
  },
  {
    id: "ai-automation",
