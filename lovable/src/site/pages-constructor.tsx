...
/* ============================================================================
   ...
   Редактура 18.09.2026 по запросу владельца об удалении нейрослопа.
   Исправлены опечатки и длинные формулировки. Цены, объем и условия
   сохранены. Действующие решения: docs/PROJECT-CONTEXT.md, журнал I-020.
   ========================================================================== */
...
/* Таблица 1 — «Подписка на услуги (конструктор задач)».
...
const SUBSCRIPTION: Unit[] = [
  {
    ...
    price: 100000,
    what: "1 программа в работе. Состав работ фиксируется в начале каждого месяца.",
  },
  {
    id: "sessions",
    title: "Сессии и модерации",
    price: 100000,
    what: "16 часов работы с группой в месяц. Подготовка, разработка и согласование сценария, отчет после сессии включены. Часы можно переносить на следующий месяц. Логистические расходы оплачиваются отдельно.",
  },
  {
    id: "trainings",
  ...
  /* Абонементы — общие с /tasks/team-subscription позиции (data.tsx). */
  ABONEMENTS.trainer,
  ABONEMENTS.methodologist,
  ABONEMENTS.coordinator,
  {
    id: "ai-automation",
  ...
  },
  {
    ...
    price: 50000,
    what: "Инфраструктура и модели — по согласованию с СБ заказчика, при необходимости в российском контуре; пополнение баланса моделей на 100 $ в месяц, донастройка работающих агентов в случае необходимости, обновление базы знаний, SLA = 60 минут, отчет о проделанной работе за месяц.",
  },
  {
    id: "maintenance",
    title: "Поддержание актуальности материалов по обучению",
    price: 40000,
    what: "Обновление учебных материалов при изменении процессов и продуктов. Задачи согласуются в начале каждого месяца.",
  },
  /* ИПР — фиксированная стоимость за пакет до 30 ИПР в месяц (реш. Виктории
     17.09.2026, вместо комиссии 25% от бюджета: та схема читалась как
     агентская). Курсы оплачиваются отдельно: напрямую или через БЕЗ ВОДЫ
     с доплатой 10% к стоимости курсов (I-002). */
  IPR_UNIT,
  {
    id: "designer",
...
const PRODUCTS: Unit[] = [
  {
    ...
    price: 100000,
    what: "Материалы на 1 день тренинга: 8 часов очно или 4 часа онлайн.",
  },
  {
    id: "adaptation",
  ...
  },
  {
    ...
    price: 60000,
    href: "/expertise-map/",
    what: "Основа для базы знаний и разработки обучения. Результат:",
    list: [
      "Карта знаний для начинающего сотрудника и логика принятия решений",
      "Карта рабочего процесса: решения сотрудника и вопросы для руководителя",
      "Матрица компетенций: что нужно знать и уметь, где границы самостоятельности",
      "Формат обучения для каждого блока знаний с обоснованием выбора",
  ...
  {
    id: "knowledge-base",
    title: "База знаний на основе опыта сильных сотрудников",
    price: 310000,
    what: "Материалы экспертов, структурированные для обучения сотрудников и работы ИИ-агента.",
  },
  {
    id: "ai-mentor",
  ...
  },
  {
    ...
    list: [
      ...
      "тестирование на идеях и бизнес-кейсах заказчика до получения валидного результата",
      "инструкция для команды: использование агента, чтение заключений, случаи возможных ошибок и порядок дополнительной проверки или донастройки",
    ],
    note: "Результат: документы в формате doc и код на GitHub.",
  },
];
      ...
      <section className="stage border-b border-[color:var(--color-line)] pb-28 md:pb-32">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pt-14 md:px-8 md:pt-20">
          <RevealHeading as="h1" className="t-h1 max-w-4xl">
            Подписка на услуги: конструктор
          </RevealHeading>
          ...
          <fieldset className="mt-14 border-0 p-0">
            <legend className="sr-only">Подписка на услуги — оплата в месяц</legend>
            <SectionLabel n="01">Подписка на услуги · в месяц</SectionLabel>
            <RevealHeading className="t-h2 mt-6 max-w-3xl">Подписка на услуги</RevealHeading>
      ...
      <div className="pointer-events-none sticky bottom-0 z-40 px-3 pb-4 md:px-6 md:pb-6">
        <div className="pointer-events-auto mx-auto max-h-[70vh] max-w-3xl overflow-y-auto rounded-md border border-[color:var(--color-line)] bg-[color:var(--color-bg-dark)] px-5 py-4 text-[color:var(--color-text-inverse)] shadow-[var(--shadow-soft)]">
          ...
          {sent ? (
            <div>
              <p className="t-body">
                {IS_PREVIEW ? "Тестовый расчет проверен. Заявка никуда не отправлена." : "Заявка отправлена. Руководитель проекта свяжется для согласования."}
              </p>
              {sentLines.length > 0 && (
