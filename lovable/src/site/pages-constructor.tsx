...
const SUBSCRIPTION: Unit[] = [
  ...
  },
  {
    ...
    price: 50000,
    what: "Мониторинг токенов, донастройка работающих агентов, обновление базы знаний, реакция на сбой в течение 2 рабочих часов, отчет о проделанной работе в месяц.",
  },
  {
    id: "designer",
