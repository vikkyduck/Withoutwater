  ...
  const packs: { title: string; items: [string, string, string?][] }[] = [
    {
      ...
      items: [
        ...
        ["Находим и оплачиваем провайдеров по обучению — комиссия 25% от бюджета", "любые инструменты для развития навыка в ИПР. От вас нужно описание запроса, все остальное делаем мы: ищем варианты, согласуем с вами, оплачиваем и организуем обучение сотрудника"],
      ],
    },
    {
