...
export function TeamSubscriptionPage() {
  ...
  const principle: [string, string][] = [
    ...
    ["Старт за 24–48 часов", "подключение проектной команды (ведущий методолог, проджект-менеджер, сборщик курсов) без необходимости проходить весь цикл подбора и адаптации."],
