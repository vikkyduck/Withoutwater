...
export function BusinessEffectGeneralPage() {
  const principles: [string, string][] = [
    ...
    ["Одна точка ответственности", "Один договор вместо набора договоров с исполнителями. Привлечение профильных экспертов, их замена и координация — наша зона. Если исполнитель не подошел, меняем за свой счет. Закрывающие документы — на одно юридическое лицо."],
