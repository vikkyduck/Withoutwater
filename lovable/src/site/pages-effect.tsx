...
export function BusinessEffectGeneralPage() {
  ...
  const startRows: [string, string][] = [
    ...
    ["24 часа", "Назначаем команду и встречаемся, когда вам удобно"],
    ["60 минут", "Представляем профили внешних экспертов, если они нужны. Бесплатно"],
  ];
...
export function ExternalExpertsEffectPage() {
  ...
  const doneSteps = [
    ...
    "За 60 минут мы представили профили экспертов клиенту",
            ...
            <div className="mt-8">
              <MetricTiles
                items={[
                  ...
                  ["60 минут", "от запроса до профилей практиков"],
                ]}
              />
            </div>
