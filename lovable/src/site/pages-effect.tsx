        ...
        <PageHead
          ...
          actions={
            <>
              ...
              <QuietLink href={BE.internal}>Как построена передача опыта ключевых сотрудников</QuietLink>
            </>
          }
        />
        <div className="relative mx-auto max-w-7xl px-5 sec-pad md:px-8">
...
export function TeamSubscriptionPage() {
  ...
  const comfort = [
    "Под каждую задачу будут необходимые ресурсы: методологию, разработку и управление проектом.",
        ...
        <PageHead
          ...
          actions={
            <>
              ...
              <QuietLink href={BE.external}>Стандарт привлечения практиков</QuietLink>
            </>
          }
        />
      </section>
  ...
  return (
    <PageShell path={BE.general}>
      <section className="stage border-b border-[color:var(--color-line)]">
        <Scene blobs={[{ className: "-right-40 top-[20%]", tone: "rose", size: 520 }]} />
        <PageHead
          kicker="Экономический эффект от услуг"
