                ...
                <div className="mt-4">
                  <NodeList
                    ...
                    items={[
                      ...
                      "Извлекаем не только факты, но и логику принятия решений, которая способствует результату",
                    ]}
                  />
                </div>
              </div>
...
export function TeamSubscriptionPage() {
  ...
  const packs: { title: string; items: [string, string][] }[] = [
    ...
    {
      title: "Переводим опыт в актив компании",
      items: [
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              <PaperCard className="h-full p-6">
                ...
                <p className="mt-4 t-body text-[color:var(--color-text-secondary)]">
                  Команда работает на своей стороне: своим инструментом, по своему
                  графику внутри согласованных сроков. Рабочие места и доступ к
                  внутренним системам нужны только там, где этого требует сама задача.
                </p>
              </PaperCard>
              <PaperCard className="h-full p-6">
                <p className="t-body text-[color:var(--color-text-primary)]">
