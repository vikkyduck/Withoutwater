...
export function TeamSubscriptionPage() {
  const corp: [string, string[]][] = [
    ...
    ["Преодоление внутренней бюрократии и скорости найма", [
      ...
      "Подписка на услуги оформляется как сервисный контракт (B2B-услуга, OpEx), бюджет на который часто уже запланирован или согласуется быстрее, чем расширение штатного расписания. Старт через 24 часа после подписания договора.",
    ]],
  ];
