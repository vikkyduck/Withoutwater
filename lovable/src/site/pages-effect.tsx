          ...
          <div className="mt-8">
            <Table3
              ...
              rows={[
                ...
                ["ФОТ в месяц*", "390 000–520 000 ₽", "от 180 000 ₽"],
                ["Налоги и страховые взносы (~30%)", "+ 117 000–156 000 ₽ / мес.", "0 ₽"],
              ...
              total={["Ежемесячные затраты со 2-го месяца", "от 507 000–676 000 ₽ / мес.", "Фиксированный пакет по договору (от 180 000 ₽)"]}
            />
          </div>
...
export function BusinessEffectGeneralPage() {
  ...
  const groups: [string, [string, string?][]][] = [
    ...
    ["Дешевле штатной команды, оплата за результат", [
      ["Без найма проектной команды", "методолог, руководитель проекта и сборщик курсов в штате обходятся от 507 000 ₽ в месяц (ФОТ по hh.ru, Москва, август 2026, с налогами и взносами); подписка на отдел обучения — от 180 000 ₽ в месяц"],
