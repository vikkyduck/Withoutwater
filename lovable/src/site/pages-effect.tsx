...
export function InternalExpertsEffectPage() {
  const effects = [
    ...
    },
    {
      ...
      problem: "Уникальная методика и понимание процессов находятся «в головах» конкретных специалистов. В случае их ухода компания теряет интеллектуальный капитал и несет прямые финансовые убытки.",
