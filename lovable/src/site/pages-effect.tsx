  ...
  const packs: { title: string; items: [string, string, string?][] }[] = [
    {
      ...
      items: [
        ...
        /* Три абонемента — те же, что в конструкторе (решение Виктории 10.08).
           Цены здесь не показываем: на публичных страницах только «от 180 000 ₽». */
        ["Абонемент на методическое сопровождение (методолог)", "Разработка учебных программ, аудит существующих курсов и создание методических материалов под запросы бизнеса в течение месяца"],
        ["Абонемент на сопровождение по обучению (бизнес-тренер)", "Проведение регулярных тренингов, оценка навыков персонала и адаптация обучающих программ под цели компании в рамках выбранного пакета"],
        ["Абонемент на проектное управление (координатор)", "Организация процессов, контроль дедлайнов, ведение проектной документации и координация рабочих встреч силами нашей компании"],
      ],
    },
    {
