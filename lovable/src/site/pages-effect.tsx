...
export function BusinessEffectGeneralPage() {
  const principles: [string, string][] = [
    ...
    ["Одна точка ответственности", "Один договор вместо набора договоров с исполнителями. Привлечение профильных экспертов, их замена и координация — наша зона. Если для результата требуется иное видение или подход, меняем состав команды за свой счет. Закрывающие документы — на одно юридическое лицо."],
  ...
  const startRows: [string, string][] = [
    ...
    ["60 минут", "Описание опыта и подтвержденные кейсы практиков, которые будут работать над задачей"],
  ];
  ...
  const startFrom: { title: string; step: string; href: string }[] = [
    ...
    { title: "Нужной практики внутри нет", step: "Первый шаг: описание опыта и кейсы практиков за 60 минут, бесплатно", href: BE.externalEffect },
  ];
...
export function ExternalExpertsPage() {
  ...
  const steps = [
    ...
    "За 60 минут — описание опыта и подтвержденные кейсы практиков, которые будут работать над задачей. Бесплатно",
    "Вы знакомитесь с практиком; если для результата требуется иное видение или подход, меняем состав команды",
  ...
  const priorities = [
    "За 60 минут у вас в почте — описание опыта и подтвержденные кейсы практиков, которые будут работать над задачей",
    "Если для результата требуется иное видение или подход, мы бесплатно меняем состав команды внутри проекта",
      ...
      <section className="stage border-b border-[color:var(--color-line)]">
        ...
        <div className="sec-dark grain relative border-t border-[color:var(--color-line-dark)]">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-5 sec-pad md:px-8">
            <SectionLabel n="02">Первый шаг</SectionLabel>
            <RevealHeading className="t-h2 mt-6 max-w-3xl text-[color:var(--color-text-inverse)]">
              Описание опыта и кейсы практиков за 60 минут. Бесплатно
            </RevealHeading>
            <p className="mt-5 max-w-3xl t-body text-[color:var(--color-text-inverse-2)]">
        ...
        <div className="sec-dark grain relative border-t border-[color:var(--color-line-dark)]">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-5 sec-pad md:px-8">
            ...
            <div className="tint-ink mt-10 max-w-3xl rounded-md border-l-2 border-[color:var(--color-accent)] p-6">
              <p className="font-display t-body font-semibold text-[color:var(--color-text-inverse)]">
                Первый шаг: описание опыта и кейсы практиков за 60 минут, бесплатно
              </p>
              <span className="mt-2 block">
                <HowLink href={BE.external} dark />
              </span>
